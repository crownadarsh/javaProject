...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    JLabel labelempId;
    JDateChooser dcdob;
    JComboBox cbqualification , cbdepartment , cbstream;
    ...
    AddTeacher(){
        ...
        labelempId = new JLabel("FAC"+first4);
        ...
        lblqualification.setBounds(50, 300, 150, 30);
        lblqualification.setFont(new Font("Tahoma",Font.BOLD,18));
        add(lblqualification);
        
        String qualification[] = {"SSC","Gradute","Post Gradute"};
        cbqualification = new JComboBox(qualification);
        cbqualification.setBounds(180, 300, 190, 30);
...
//        add(cbstream);
        ...
        JLabel lblcourse = new JLabel("Select Department");
        lblcourse.setBounds(400, 300,200, 30);
        lblcourse.setFont(new Font("Tahoma",Font.BOLD,20));
        add(lblcourse);
        
        String department[] = {"Physics","Maths","Chemistry","Biology","Humanities","English","Commerce"};
        cbdepartment = new JComboBox(department);
        cbdepartment.setBounds(600, 300, 220, 30);
        cbdepartment.setBackground(Color.WHITE);
        cbdepartment.setForeground(Color.GREEN);
        cbdepartment.setFont(new Font("Tahoma",Font.BOLD,20));
        add(cbdepartment);
...
//            String stream = (String) cbstream.getSelectedItem();
            ...
            try {
                ...
                String query = "insert into teacher values('"+name+"','"+fname+"','"+empId+"','"+dob+"','"+address+"','"+mno+"','"+email+"','"+adhar+"','"+qualification+"','"+department+"')";
                Conn con = new Conn();
                con.s.executeUpdate(query);
                //,'"+stream+"'
                
                JOptionPane.showMessageDialog(null, "Teacher Details Inserted Successfuly");
                setVisible(false);
